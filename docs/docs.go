...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.CreateOpeneningReponse"
                        }
                    },
                    "400": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.DeleteOpeneningReponse"
                        }
                    },
                    "404": {
    ...
    "definitions": {
        "handler.CreateOpeneningReponse": {
            "type": "object",
            "properties": {
                "data": {
        ...
        "handler.DeleteOpeneningReponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/schemas.OpeningResponse"
